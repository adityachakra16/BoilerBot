...
if __name__=="__main__":
    ...
    if SOURCE == 'video':
        ...
        while(True):
            ...
            #-- Detect keypoints
            keypoints, _ = blob_detect(frame, lane_min, lane_max, blur=3, 
        ...
        image_list = []
        image_list.append(cv2.imread("lane1.jpeg"))
        image_list.append(cv2.imread("lane2.jpeg"))
        image_list.append(cv2.imread("lane3.jpg"))

        for image in image_list:
            #-- Detect keypoints
            keypoints, _ = blob_detect(image, lane_min, lane_max, blur=5, 
                                        blob_params=None, search_window=window, imshow=True)
